...
export default function EditTestimonialPage() {
    ...
    if (fetching) return <div className="text-center p-20 animate-pulse text-slate-400">Loading testimonial data...</div>;

    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter">Edit Testimonial</h1>
                    <p className="text-slate-500 text-sm italic">Update the client review details.</p>
                </div>
                <Link href="/admin/testimonials" className="px-6 py-2.5 rounded-lg text-xs font-bold uppercase tracking-widest text-slate-500 hover:text-slate-900 transition-all border border-slate-200 bg-white shadow-sm">Cancel Changes</Link>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6 bg-[#123A2F] p-8 rounded-3xl md:col-span-2">
                        ...
                        <div className="pt-4 border-t border-white/10 mt-4 flex justify-end">
                            ...
                            >
                                {loading ? "Saving Changes..." : "Update Testimonial"}
                            </button>
                        </div>
                    </div>
                </div>
