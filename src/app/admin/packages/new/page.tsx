    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-6xl mx-auto">
            <div className="flex justify-between items-center mb-8 border-b border-slate-200 pb-6">
                <div>
                    <h1 className="text-3xl font-black tracking-tighter">New Package Builder</h1>
                    <p className="text-slate-500 text-sm italic">Build a custom bundle with dynamic pricing rules</p>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-[#123A2F] text-white p-8 rounded-2xl shadow-xl shadow-[#1F5C4B]/20">
                        ...
                        <div className="pt-6 border-t border-white/20">
                            ...
                            {contactForPrice && <p className="text-amber-400 text-[10px] font-black uppercase tracking-widest mt-2 animate-pulse">Public price hidden</p>}
                        </div>
                    </div>
